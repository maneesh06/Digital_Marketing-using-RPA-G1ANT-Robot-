...
{
    [Command(Name = "instagramapp.open", Tooltip = "This command initialises (open) Instagram app.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.instagram.mainactivity.LauncherActivity");
