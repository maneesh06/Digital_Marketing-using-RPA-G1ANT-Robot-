...
{
    [Command(Name = "quoraapp.spaces", Tooltip = "This command open spaces page in Quora App")]
    public class QuoraAppSpacesCommand : Language.Command
    {
        ...
        public QuoraAppSpacesCommand(AbstractScripter scripter) : base(scripter)
        {
