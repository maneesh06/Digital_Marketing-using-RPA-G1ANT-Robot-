...
{
    [Command(Name = "quoraapp.giveanswer", Tooltip = "This command open question answer page on QuoraApp")]
    public class QuoraAppGiveAnswerCommand : Language.Command
    {
        ...
        public QuoraAppGiveAnswerCommand(AbstractScripter scripter) : base(scripter)
        {
