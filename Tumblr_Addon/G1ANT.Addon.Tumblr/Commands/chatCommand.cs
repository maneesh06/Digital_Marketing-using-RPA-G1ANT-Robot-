...
namespace G1ANT.Addon.Tumblr
{
    ...
    [Command(Name = "tumblr.chat", Tooltip = "This command is used to add a chat on tumblr platform.")]
    public class chatCommand : Command
    {
        ...
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure chatvalue { get; set; }
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                Thread.Sleep(500);
                arguments.Search.Value = "/html/body/div/div[1]/div[1]/div[2]/div[1]/main/div[3]/ul/li[5]/button";
                ...
                arguments.Search.Value = "/html/body/div[3]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[2]/div/div/div[1]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                SeleniumManager.CurrentWrapper.TypeText(arguments.chatvalue.Value, arguments, arguments.Timeout.Value);
