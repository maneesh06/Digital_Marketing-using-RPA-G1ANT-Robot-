...
{
    [Command(Name = "flipkartapp.backbutton", Tooltip = "This command clicks on a back button of android phone.")]
    public class FlipkartAppBackButtonCommand : Language.Command
    {
        ...
        public FlipkartAppBackButtonCommand(AbstractScripter scripter) : base(scripter)
        {
