...
{
    [Command(Name = "flipkartapp.hotelorflights", Tooltip = "This command helps you to show hotels and flights on Flipkart app")]
    public class FlipkartAppHotelorFlightsCommand : Language.Command
    {
        ...
        public FlipkartAppHotelorFlightsCommand(AbstractScripter scripter) : base(scripter)
        {
